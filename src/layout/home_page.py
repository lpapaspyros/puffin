...
def homepage():
    ...
    2. **Gain insights from your data**
        ...
        - **Get Data Insights:** View descriptive information and statistics about your data set and a generated interpretation of the results.
        - **Visualize and get ploting tips:** Use PyGWalker to create graphs from your data and view generated tips on how to best plot and visualize your data.
    ...
    Get descriptive statistics on your uploaded data set and see an 
    autogenerated interpretation of your data. 
    Create custom plot using PyGWalker and view autogenerated suggestions
    on how to best visualize your data.

    """
    )
    gif_path = os.path.join(work_dir, "assets", "gifs", "data_insights_demo.gif")
    display_gif(gif_path, width="80%")
